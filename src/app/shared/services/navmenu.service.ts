  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "/email/letter-box", title: "Letter-box", type: "link" },
      ],
    },
    {
      id: 8,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: "https://admin.pixelstrap.net/dunzo/template/basic-template.html",
              title: "Basic Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/dunzo/template/email-header.html",
              title: "Basic With Header",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/dunzo/template/template-email.html",
              title: "Ecomerce Template",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/dunzo/template/template-email-2.html",
              title: "Email Template 2",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/dunzo/template/ecommerce-templates.html",
              title: "Ecommerce Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/dunzo/template/email-order-success.html",
              title: "Order Success",
              type: "extTabLink",
            },
          ],
